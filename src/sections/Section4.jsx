import Svg from '../components/svg/linux'
export default function Section1() {
  return (
    <>
      <div className='relative mx-5 md:max-w-[60vw] p-5 md:p-20 space-y-12 border-t-4 md:border-l-4 border-amber-600'>
        {/* Title on Border */}
        ...
        <div>
          ...
          <p className='mt-2 mb-4 text-base md:text-xl text-white'>
            ...
            dedicated personal time to advancing my skills in Go and AWS.
          </p>
